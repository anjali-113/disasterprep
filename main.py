...
@app.route('/contacts')
def contact():
    return render_template('contact.html').format(contact=url_for('contact'))
...
@app.route('/diseaseHome')
def diseaseHome():
    return render_template('disease_entry.html')
